...
- **Japanese market:** Article title starts with `東証大引け`
  ...
  - Output file: `C:\Users\kaika\Desktop\ClaudeCode\金融レポート作成\東証分類構造化.txt`

- **US market:** Article title starts with `米国株、`

  - Example: "米国株、ダウ反発し319ドル高..."
  - Output file: `C:\Users\kaika\Desktop\ClaudeCode\金融レポート作成\米国株分類構造化.txt`
...
- **市況日付の確定ルール（最重要）:**
  - **日本株（東証）:** 東証の市況は当日夕方に記事となるため、記事の日付＝市況の日付
  - **米国株:** 米国市場は現地時間の当日市況が日本では翌日早朝に記事となるため、基本的に記事日付の前日＝市況の日付
  - **例外への対応（必須）:** 上記はあくまで原則。必ず記事本文中の「●日の東京市場で」「●日の米株式市場で」などの記述を探し、そこに明記された日付で市況日付を確定する
  - 記事本文の日付記述が最優先。原則論で決めてはならない
...
- **曜日の決定ルール（最重要）:**
  ...
  - 月曜が祝日であればその週の最初の取引日は火曜だが、曜日はあくまで「火」であり「月」ではない
...
**記号の付け方:**
- `* 〇 CPIが予想を下回り利下げ期待が高まった`
- `  * 〇 好感された材料`
- `    * × 景気後退懸念も一部で意識された`
- Level 1（市場全体の動き要約）にも記号を付ける
- 「好感された材料」「嫌気された材料」の見出し自体にも記号を付ける（前者は〇、後者は×）
...
6. [ ] 全ての箇条書き項目に〇/×/△の記号を付けたか？
7. [ ] 市況日付を記事本文中の「●日の○○市場で」という記述から確定したか？
7. [ ] 曜日は市況日付から数学的に計算したか？（「週の始めだから月曜」などの推論で当てはめていないか？）
...
**✅ 正しい例（階層的な構造化＋ポジネガ記号）：**
```markdown
* 〇 1月の消費者物価指数（CPI）が市場予想を下回り、FRBの追加利下げ観測が高まった
  * 〇 1月のCPIが前年同月比2.4％上昇と市場予想（2.5％上昇）を下回る
    * 〇 6月か7月の利下げ観測を背景に米長期金利が低下
  * 〇 好感された材料
    * 〇 半導体製造装置のアプライドマテリアルズ（AMAT）の業績見通しが好感され、AI市場の拡大期待が高まった
```
